...
---
## **kill 명령어**
**'kill'** 명령어는 프로세스에 특정한 signal을 보내는 명령어이다.
...
### 사용 가능한 시그널목록
-l 옵션을 통해 지원하는 시그널의 목록을 확인할 수 있다.
시그널은 여러 종류가 있고 각각 번호가 붙어있다.

***시그널은 많지만 자주 사용하는 시그널만 사용 된다.***

![kill -l 실행 화면](https://github.com/dongheon123/assignment_20233061/assets/113902969/02359167-4446-4352-9c5a-14b1c832ff72)
...
- 1 (SIGHUP) : 종료
- 2 (SIGINT) : 인터럽트 종료
- 9 (SIGKILL) : 프로그램 강제 종료 **(데이터 유실 위험)**.
...
- -l : 신호(signal)로 사용할 수 있는 신호 이름들을 보여준다.
